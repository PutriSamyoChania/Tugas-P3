...
public class JavaApplication_PutriSamyoChania {
  
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        Scanner sc = new Scanner(System.in);
        Integer pilihan = 0;
        int harga_item[] = {20000, 30000, 25000, 35000};
        String menu = null;
        int pembayaran;
        ...
        System.out.println("| 2. Arabika                  |   Rp 30000      |");
        System.out.println("| 3. Latte                    |   Rp 25000      |");
        System.out.println("| 4. Matcha                   |   Rp 35000      |");
        ...
        if (input_item == 1)
        {
            ...
            System.out.println("Menu Pesanan Anda : " + menu +"    p"+ jumlah+"   |  Rp. "+ pembayaran);
        ...
        else
        {
            ...
            System.out.println("Apakah anda mau pesan menu lagi? Y/T");
            a = input.next();
        }
